...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/', component: ConsoleLayout, children: [
      ...
      { path: 'products/:id', component: () => import('@/views/product/ProductDetailView.vue'), meta: { title: '产品详情', permission: 'product:read' } },
      { path: 'packages', component: () => import('@/views/product/PackageView.vue'), meta: { title: '套餐管理', permission: 'product:package:read' } },
      { path: 'resource-strategies', component: () => import('@/views/product/ResourceStrategyView.vue'), meta: { title: '产品资源策略', permission: 'product:strategy:read' } },
