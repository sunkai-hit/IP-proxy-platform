...
export const productApi = {
  ...
  enableProduct:(id:number,reason:string)=>http.post(`/v12/products/${id}/enable`,{reason}), disableProduct:(id:number,reason:string)=>http.post(`/v12/products/${id}/disable`,{reason}), copyProduct:(id:number,reason:string)=>http.post(`/products/${id}/copy`,{reason}),
