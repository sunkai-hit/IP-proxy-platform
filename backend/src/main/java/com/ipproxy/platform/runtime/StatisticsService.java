...
public class StatisticsService {
    ...
    private final InfrastructureStatisticsRepository infrastructure;
    public StatisticsService(RuntimeOperationsRepository db,InfrastructureStatisticsRepository infrastructure){this.db=db;this.infrastructure=infrastructure;}
    ...
    public Map<String,Object> dashboard(){return infrastructure.dashboard();}
