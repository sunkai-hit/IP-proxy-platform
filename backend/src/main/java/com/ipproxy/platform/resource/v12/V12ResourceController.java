...
public class V12ResourceController {
    ...
    @GetMapping("/resources/ros") public ApiResponse<?> ros(@RequestParam(defaultValue="1")int page,@RequestParam(defaultValue="20")int size,@RequestParam(defaultValue="")String keyword,@RequestParam(defaultValue="")String status,@AuthenticationPrincipal UserPrincipal p){require(p,"resource:read");return ApiResponse.success(service.ros(page,size,keyword,status));}
    ...
    @GetMapping("/resources/lines") public ApiResponse<?> lines(@RequestParam(defaultValue="1")int page,@RequestParam(defaultValue="20")int size,@RequestParam(defaultValue="")String keyword,@RequestParam(defaultValue="")String status,@RequestParam(required=false)Long rosId,@RequestParam(defaultValue="")String type,@RequestParam(defaultValue="")String province,@RequestParam(defaultValue="")String city,@RequestParam(defaultValue="")String carrier,@AuthenticationPrincipal UserPrincipal p){require(p,"resource:read");return ApiResponse.success(service.lines(page,size,keyword,status,rosId,type,province,city,carrier));}
