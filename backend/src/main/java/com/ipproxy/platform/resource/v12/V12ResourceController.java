...
public class V12ResourceController {
    ...
    @PostMapping("/resources/lines/{id}/type") public ApiResponse<?> lineType(@PathVariable Long id,@RequestBody LineTypeInput b,@AuthenticationPrincipal UserPrincipal p,HttpServletRequest r){require(p,"resource:write");return ApiResponse.success(service.setLineType(id,b.type(),b.reason(),p,ip(r)));}
